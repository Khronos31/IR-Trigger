...
USB赤外線送信機 **AD00020P** を使用する場合、ハードウェアの不具合により一部のNEC方式の受信機が反応しないことがあります。その際は、デバイス設定で `force_aeha_tx: true` を指定することで回避できる可能性があります。
